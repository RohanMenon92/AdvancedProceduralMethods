...
//		Vector3(xwidth, yheight, zdepth),false);
//	m_vertexCount = preFabVertices.size();
//	m_indexCount = preFabIndices.size();
//
//	bool result;
...
//	{
//		vertices[i].position	= Vector3(preFabVertices[i].position.x, preFabVertices[i].position.y, preFabVertices[i].position.z);
//		vertices[i].texture		= Vector2(preFabVertices[i].textureCoordinate.x, preFabVertices[i].textureCoordinate.y);
//		vertices[i].normal		= Vector3(preFabVertices[i].normal.x, preFabVertices[i].normal.y, preFabVertices[i].normal.z);
//	}
