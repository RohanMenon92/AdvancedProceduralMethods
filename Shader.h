...
public:
	...
	bool SetShaderParameters(ID3D11DeviceContext * context, Matrix  *world, Matrix  *view, Matrix  *projection, Light *sceneLight1, ID3D11ShaderResourceView* texture1, ID3D11ShaderResourceView* texture2);
