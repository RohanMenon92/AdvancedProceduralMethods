...
bool Skydome::Initialize(ID3D11Device* device)
{
	...
	result = LoadSkyDomeModel("Assets/skydome.txt");
	if (!result)
	{
		return false;
	}
	...
	m_apexColor = Vector4(0.733f, 0.8f, 0.839f, 1.0f);

	// Set the color at the center of the sky dome.
	m_centerColor = Vector4(0.93f, 0.95f, 0.97f, 1.0f);
...
Vector4 Skydome::GetApexColor()
{
	return m_apexColor;
}


Vector4 Skydome::GetCenterColor()
{
